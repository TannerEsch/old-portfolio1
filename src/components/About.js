...
import AboutRight from "./AboutRight";
 ...
 function About() {
    ...
    return(
        <div style={{fontFamily: "Chivo Mono", color: "white"}}>
            ...
            <h1 style={{position: "absolute", fontSize: "70px", top:"0px", left: "375px", textDecoration: "underline"}}>About me!</h1>
            <div style={{position: "absolute", width: "500px", fontSize: "35px", top:"200px", left: "360px", textDecoration: "underline"}}> 

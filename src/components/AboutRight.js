 ...
 function AboutRight() {
    ...
    return(
        <div style={{fontFamily: "Chivo Mono"}}>
            ...
            <br/>
            A: In terms of coding, I know Python, Javascript, HTML, CSS, SQL, and I can work with several other Frameworks and Databases like Django, React, Flask, PostgreSQL, MongoDB, etc. 
            <br/>
            A: In terms of spoken languages, I'm fluent in English, my Spanish(spain Spanish) is pretty solid, and I know a small amount of French.
            </div>
        </div>
    )
 };
